-- Migration to add Battle.net authentication tables for MySQL
...
SET @sqlUsers = IF(@usersExists = 0, 
  'CREATE TABLE users (
    ...
    battle_tag VARCHAR(255) NOT NULL DEFAULT '',
    email VARCHAR(255),
    access_token TEXT,
    refresh_token TEXT,
...
SET @sqlUserCharacters = IF(@userCharactersExists = 0, 
  'CREATE TABLE user_characters (
    ...
    UNIQUE KEY unique_user_character_pairing (user_id, character_id)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4', 
