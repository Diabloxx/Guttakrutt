-- Add web_logs table for tracking system operations (MySQL 8+ version)
CREATE TABLE IF NOT EXISTS web_logs (
  ...
  user_agent TEXT,
  CONSTRAINT fk_web_logs_user FOREIGN KEY (user_id) REFERENCES admin_users(id) ON DELETE SET NULL
);
...
-- Skip creating this index as it's automatically created with the foreign key
