...
set MYSQL_PORT=3306
set MYSQL_USER=root
set MYSQL_PASSWORD=Ripper97!!#
set MYSQL_DATABASE=guttakrutt
Set SITE_URL=https://guttakrutt.org

:: Blizzard and WarcraftLogs API keys
set BLIZZARD_CLIENT_ID=4302396830ca4f728b5e6425f8d921e7
set BLIZZARD_CLIENT_SECRET=tEKKH2aHJaG3L6AB9olXcdBvhNCUZMqu
set WARCRAFTLOGS_CLIENT_ID=9ebc4b21-7102-4b09-aceb-9dad90f4ae83
set WARCRAFTLOGS_CLIENT_SECRET=0rZvG3fJUJChArzwyXdXsL6msyaraaN3lUnt2gTV
